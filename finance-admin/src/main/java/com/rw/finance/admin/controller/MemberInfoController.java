...
public class MemberInfoController {
    ...
    public Result getMemberDetail(@RequestParam(value = "memberid", required = true) Long memberid, @RequestParam
            (value = "agentlevel", required = true) int agentlevel) {
        return new Result(200, null, this.memberInfoService.getMemberDetail(memberid, agentlevel));
    }
